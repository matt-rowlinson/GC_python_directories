...
def plot(ax, times, obs=False,
    ...
    plt.tight_layout()
    plt.savefig( f"plots/{site['save_name']}_{v}_v13-1-2_DUST.png" )
    plt.close()
    return
...
def main():
    ...
    site = sites[site]
    rundirs  = ['nitrate_photol_2017_control','nitrate_photol_control_DUST']
    versions = ['13.1.2','13.1.2']
    labels = ['v13.1.2','v13.1.2_wDust']
    variables=['O3','SALAAL','SALCAL','NOx','all_nitrate','NIT','NITs', 'NH3','HNO3','all_sulphate','SO2','SO4','CO','NH4']
    years='2017'
