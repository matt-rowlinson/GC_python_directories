...
def time_plot(species, xy, ds, rundirs, labels=None, sname=''):
    ...
    for d, rundir, label in zip(ds, rundirs,labels):
        print( rundir )
        d = d[f'SpeciesConcVV_{species}'] * 1e9
...
def main():
    ...
    rundirs  = ['new_base_4x5','DD_new_base_4x5','langmuir_4x5','DD_langmuir_4x5']#shah_4x5','andersen_4x5','langmuir_4x5','langmuir_RH_4x5']
    labels=['Base','DD Base','Langmuir','DD Langmuir']#Shah et al.','Andersen et al.','New langmuir', r'New langmuir $\times$ RH']#Andersen_RHbin','Shah et al.']

    version = '14.1.0'
    species_=['O3','HNO2', 'O3', 'CO']
    dates   ='2015'
    ...
    for species in species_:
        print( species )
        time_plot( species, xy, ds_, rundirs, labels=labels, sname=f'DD_timeseries.14.1.0.{species}_NIThv' )
