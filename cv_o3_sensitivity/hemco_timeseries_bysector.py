...
sectors = ['Anthro','BioBurn','Aircraft','Ship','Geo']
...
rundirs = ['fullchem_hourly_default','fullchem_onlyCEDS','geo_ethane']#, 
...
for region in regions:
    ...
    plt.legend()
    plt.savefig('plots/onlyEMS_%s_anthro_ethane_emissions.png' %out)
    plt.close()
    sys.exit()
