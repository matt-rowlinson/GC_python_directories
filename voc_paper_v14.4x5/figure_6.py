...
ax1.plot( df0[0].geo, color=colors[0], label='Base' )
ax1.plot( df0[0].scale_all, color=colors[1], label='Scaled CEDS emissions' )
...
df = df.loc['2017'].resample('D').mean()
ax2.plot( df0[1].geo, c=colors[0], label='Base' )
ax2.plot( df0[1].scale_all, color=colors[1], label='Scaled CEDS emissions' )
...
df = df.loc['2017'].resample('D').mean()
ax3.plot( df0[2].geo, c=colors[0], label='Base' )
ax3.plot( df0[2].scale_all, color=colors[1], label='Scaled CEDS emissions' )
...
df = df.loc['2017'].resample('D').mean()
ax4.plot( df0[3].geo, c=colors[0], label='Base' )
ax4.plot( df0[3].scale_all, color=colors[1], label='Scaled CEDS emissions' )
...
df = df.loc['2017'].resample('D').mean()
ax5.plot( df0[4].geo, c=colors[0], label='Base' )
ax5.plot( df0[4].scale_all, color=colors[1], label='Scaled CEDS emissions' )
ax5.plot( df, c='k', label='Observed' )
ax5.legend()
ax5.set_ylabel( 'Propene (pptv)' )
...
df = iB + nB + iP + nP
df = df.loc['2017'].resample('D').mean()
ax6.plot( df0[5].geo, c=colors[0], label='Base' )
ax6.plot( df0[5].scale_all, color=colors[1], label='Scaled CEDS emissions' )
