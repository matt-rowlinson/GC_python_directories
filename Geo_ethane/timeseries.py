...
rundirs=['fullchem_4x5hourly_default', '2xethane_EU', '2xethane_US','2xethane_Asia', '2xethane_Afr']
rundirs=['fullchem_4x5_LVOCfalse', 'geo_ethane_NEI', 'geo_ethane_propane']
...
labels=['HEMCO_default','CEDS + Geological ethane + NEI','CEDS + Geological C2 + NEI']
