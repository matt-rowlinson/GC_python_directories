...
def main():
    ...
    ax2.plot(obs_[1], a2 * obs_[1], '-', c='darkorange', zorder=10)
    ...
    # ALK4
    Pdev = ax3.scatter( alk4_obs, alk4_model2, c='g', alpha=.00005, zorder=1)
    ...
    ax3.plot(alk4_obs, a2 * alk4_obs, '-', c='darkorange', zorder=10)
    ...
    plt.delaxes(ax4)
    plt.savefig('paper_figures/figure_4b.png')
    plt.close()
