...
def cart_plot(rundirs, base, sname=''):
    ...
    im = base.plot.imshow( x='lon',y='lat', center=0, ax=ax, transform=ccrs.PlateCarree(),
            cbar_kwargs = {'orientation':'horizontal', 'label':'W m$^{-2}$','spacing': 'proportional'}) 
    ax.coastlines()
...
def main():
    ...
    rundirs  = ['j25_run_1751','j25_run_2015']#,'j100_run_1751','j100_run_2000']#
    #rundirs  = ['j100_run_1751','j100_run_2010']#,'viral_run_1751','viral_run_2015']
    #rundirs  = ['Ander22b_run_1751','viral_run_2015']
    ...
    NRF = np.sum( NRF * AREA) / np.sum( AREA )  # weighted by area
    print( NRF.mean().values)
