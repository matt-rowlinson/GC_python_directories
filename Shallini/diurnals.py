...
def find_model_output_for_site(ds, rundirs, versions, v, years='2017'):
    ...
    for n, rundir in enumerate(rundirs):
        ...
        if site['save_name']=='cvao':
            ds0=ds0['2006-10-01':]
        ds0 = ds0['2015':'2019']
        ds0 = ds0.groupby(ds0.index.hour).mean()
...
def main():
    ...
    site = sites[site]
    rundirs  = ['OVOCs_control']
    versions = ['13.1.2']
    sname='OVOCs'
    variables=['methanol','acetone']#','ACET','ALD2']
    years='201'
    cs=['#1b9e77','#e7298a','#d95f02','#7570b3','#e7298a','#66a61e','#e6ab02']
    for v in variables:
        print( v )
        add_times = find_model_output_for_site(ds, rundirs, versions, v, years='201501')
        ...
        ax.plot( range(1,25), add_times[0], label='v13.1.2')
