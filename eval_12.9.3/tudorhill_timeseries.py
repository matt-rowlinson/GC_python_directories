...
y = rp.find_nearest(lat, 32.265)
x = rp.find_nearest(lon, -64.8786)
var_time=[]
...
df=pd.read_csv('/users/mjr583/scratch/NCAS_CVAO/GAW_datasets/ber_ozone_2006_to_2018.csv', delimiter=',', index_col=0)
...
ax.plot(df.index, df.Value, 'k', label='Tudor Hill (Ber) Observations')
...
#plt.ylim((7.5,52.5))
plt.legend()
plt.savefig('/users/mjr583/GC/eval_12.9.3/plots/tudorhill_2016_%s.png' %(variable) )
plt.close()
