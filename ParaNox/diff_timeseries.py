...
rundirs=['no_shipping_global','no_shipping_paranox_off']#fullchem_hourly_default', 'paranox_off']
string=''+k+'_sensitivity'

dfs=[]
for a in rundirs:
    print(a, '!!')
    var, lat, lon, lev, atime = GC.get_gc_var(rundir=a, variable=variable, version='GEOS-Chem', year='2018')
