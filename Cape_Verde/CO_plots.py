...
def main():
    ...
    df0 = pd.read_csv('/mnt/lustre/users/mjr583/NCAS_CVAO/CVAO_datasets/Ebas_220513_0745/CVAO_CO_Ebas_20220513.csv',
                    index_col=0)
    ...
    ds = find_model_output_for_site(ds, ['nitrate_photol_control'], ['13.1.2'], var, years='20')[0]['2008-04':]
    ...
    ax1.plot(df2.index, eval_DF['g'][1:], color='k', linewidth= 3, label="CVAO")
    ax1.plot(ds1.index, eval_DF2['g'][1:], color='green', linewidth= 3, label="GEOS-Chem")
