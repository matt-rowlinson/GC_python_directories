...
def get_data_as_xr(rundir, year='', lev=0, version='13.1.2'):
...
for variable in variables:
    ...
    dfs=[]
    for a in rundirs:
        var, lat, lon, lev, atime = GC.get_gc_var(rundir=a, variable=variable, version='13.4.0', year='2016')
...
df = df.loc['2016'].resample( 'D' ).mean()
ax1.plot( df0[0].ceds_only, color=colors[0], label='Base' )
ax1.plot( df0[0]["geo_only"], color=colors[1], label='Geo emissions' )
ax1.plot( df0[0]["all_scaled"], color=colors[1], label='Scaled CEDS' )
...
ax2.plot( df0[1]["geo_only"], color=colors[1], label='Geo emissions' )
ax1.plot( df0[0]["all_scaled"], color=colors[1], label='Scaled CEDS' )
...
ax5.plot( df0[2]["geo_only"], color=colors[1], label='Geo emissions' )
ax1.plot( df0[0]["all_scaled"], color=colors[1], label='Scaled CEDS' )
...
ax4.plot( df0[3]["geo_only"], color=colors[1], label='Geo emissions' )
ax1.plot( df0[0]["all_scaled"], color=colors[1], label='Scaled CEDS' )
...
ax6.plot( df0[4]["geo_only"], color=colors[1], label='Geo emissions' )
ax1.plot( df0[0]["all_scaled"], color=colors[1], label='Scaled CEDS' )
...
ax3.plot( df0[5]["geo_only"], color=colors[1], label='Geo emissions' )
ax1.plot( df0[0]["all_scaled"], color=colors[1], label='Scaled CEDS' )
...
def main():
    ...
    ds0, lon, lat = get_data_as_xr(rundirs[0], version='13.4.0')
    ds1, lon, lat = get_data_as_xr(rundirs[1], version='13.4.0')
    ds2, lon, lat = get_data_as_xr(rundirs[2], version='13.4.0')
