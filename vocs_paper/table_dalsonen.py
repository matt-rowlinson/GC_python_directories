...
ceds  = [  7.13,  0.33, 0.71, 1.2 ]
ceds21= [ 4.94, np.nan,np.nan,np.nan]
edgar = [ 4.855, 0.29, 0.50, 0.65 ]
me    = [ 11.02, 2.03, 1.55, 2.88 ]
me2   = [ 8.97 , np.nan, np.nan, np.nan ]
...
ax1.scatter( xticks, CEDS21, s=102,c='r',   marker='o', label='CEDS 2021' )
...
## Propane emissions
ceds  = [ 6.49, 0.36, 0.83, 1.2 ]
ceds21= [ 4.13, np.nan,np.nan,np.nan]
edgar = [ 6.22, 0.2379, 0.411, 1.4 ]
me    = [ 8.2, 1.21, 1.39, 1.88 ]
me2   = [ 6.50, np.nan, np.nan, np.nan ]
...
ax2.scatter( xticks, ceds21,s=102,c='r',   marker='o', label='CEDS 2021' )
