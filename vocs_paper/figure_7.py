...
def main():
    variables=['ethane','propane','EOH','CH2O','PRPE','MEK','ALK4','benzene','toluene','XYLE']#,'
    ...
    for n in range(10):
        ...
        #im = ax.pcolormesh(X, Y, add_plottable[n], cmap='bwr', vmax=ax_Max[n], vmin=-(ax_Max[n]),)
    ...
    #plt.delaxes(ax12)
    plt.tight_layout()
    plt.savefig( f"plots/figure_7.png", dpi=200 )
    plt.close()
