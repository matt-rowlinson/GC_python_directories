...
def main():
    ...
    core_spec=['CO']#,'CO','NO','NO2']
    Ycore_spec=['CO']#,'CO','NO','NO2']
    rundirs  = ['j25-SS_run_2015']#,'viral_run_2015','Ander22b_run_2015']
    labels=['Kasibhatla et al. 2018']#,'Shah et al. 2022','Andersen et al. 2022']
    b=[]
