...
def main():
    ...
    rundirs  = ['nitrate_photol_control', 'TEST']
    versions = ['13.1.2_DUST','13.4.0']

    variables=['O3','HNO3','Iy','SALAAL','SALCAL','O3', 'NITA','SO4A','NIT', 'NITs','SO4','SO2','all_nitrate','all_sulphate','O3','CO','NH3','NH4']
    units = ['pptv','ppbv','pptv','pptv','pptv','pptv','ppbv','ppbv','ppbv','ppbv','ppbv','ppbv'][::-1]
    for nn, v in enumerate(variables):
        ...
        plot( f, axes, add_plottable, lat, lon, c=cmap, 
                ...
                labels=['13.4.0_wDust - 13.1.2_wDust','13.4.0_wDust / 13.1.2_wDust'],
                sname=f'v13-4_{v}')
