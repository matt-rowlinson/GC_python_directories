...
def main():
    ...
    site = sites[site]
    rundirs  = ['nitrate_photol_2017_control','TEST_NO_DUST']
    versions = ['13.1.2','13.4.0']
    labels = ['v13.1.2','v13.4.0']
    variables=['O3','SALAAL','SALCAL','NOx','O3','all_nitrate','NIT','NITs', 'NH3','HNO3','all_sulphate','SO2','SO4','CO','NH4']
    years='2017'
