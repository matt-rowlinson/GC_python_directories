...
def plot(ax, times, obs=False,
    ...
    plt.tight_layout()
    plt.savefig( f"plots/TEST.propane_base-v-base.png" )
    plt.close()
    return
...
def main():
    ...
    site = sites[site]
    rundirs  = ['ceds_only','geo_only']#,'geo_only','geo_only']
    versions = ['13.1.2','13.4.0']#3.1','13.3.4', '13.4.0']
    labels = versions# [v13.1.2','v13.1.2_wDust']#,'v13.4.0_wDust']
    variables=['C3H8']#,'SALAAL','SALCAL','NOx']#,'all_nitrate','NIT','NITs', 'NH3','HNO3','all_sulphate','SO2','SO4','CO','NH4']
    years='2016'
    cs=['#1b9e77','#e7298a','#d95f02','#7570b3','#e7298a','#66a61e','#e6ab02']
    for v in variables:
        print( v )
