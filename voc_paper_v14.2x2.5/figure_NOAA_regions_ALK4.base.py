...
def main():
    ...
    for nn, ax, var,alpha in zip(range(6), axes, ps,alphas):
        for n, rundir in enumerate(rundirs):
            ...
            #print( var[rundir].min() )
            #print( var[rundir].max() )
        #print( var.analysis_value.min() )
        #print( var.analysis_value.max() )
    ...
    #plt.tight_layout()
    #plt.savefig('plots/NOAA_regions_alk4.base,png')
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig('plots/NOAA_regions_alk4_log.base.png')
    plt.close()
