...
def main():
    ...
    gcvar   = 'TOLU'
    form    = 'C6H5CH3'
    sites = ['Zeppelin','Hohenpeissenberg','Rigi','Monte_Cimone']
    ds0 = get_data_as_xr(rundirs[0], years)
    ds1 = get_data_as_xr(rundirs[1], years)
    
    fig = plt.figure(figsize=(11,9.2), tight_layout=True)
    ...
    for site, ax, ax_ in zip(sites, axes, axes2):
        ...
        ax.text(0.02, 0.05, textstr, transform=ax.transAxes, fontsize=11,
