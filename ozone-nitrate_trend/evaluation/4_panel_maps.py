...
def main():
    ...
    Jvals=['25','50','100','1000']
    for J in Jvals:
        rundirs = ['nitrate_photol_2015_control', f'nitrate_photol_2015_all_scale-{J}']#,

        variables=['DST']#NOx','NIT', 'HNO2']#, 'CO']
        for v in variables:
            print( v )
            ...
            plot( f, axes, add_plottable, lat, lon, c=cmap, 
                    ...
                    labels=['Base', f'All nitrate Jscale={J}', 'Jscale - Base','Jscale / Base'],
                    sname=f'J{J}_{v}')
