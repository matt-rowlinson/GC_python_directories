...
years=['2017','2015','2010','2005','2000','1995','1990','1985','1980']
to_remove=False
replace=False; err=''
for year in years[::-1]:
    indir=f'nitrate_photol_{year}_CH4FIX'#NITS_scale-25'
    outdir='nitrate_photol_CH4FIX'#NITS_Jscale-25'
    ...
    want=['O3','HNO2','NIT','NITs','NO','NO2','CO','SO2','SO4','SO4s','NH3','HNO3','C2H6','C3H8','BENZ']
    print( inpath )
    for infile in sorted(glob.glob(f'{inpath}/GEOSChem.SpeciesConc.*')):
