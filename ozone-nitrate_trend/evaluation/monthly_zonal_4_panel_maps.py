...
def main():
    ...
    rundirs  = ['nitrate_photol_2015_all_scale-100', 'nitrate_photol_2015_all_scale-1000']
    top_lev=32
    ...
    for mon in months:
        ...
        labels=[f'Base 2018{mon}','Jscale = 1000','J1000 - Base','J1000 / Base']
        for nn, v in enumerate(variables):
            ...
            for n, rundir in enumerate(rundirs):
                ds0, lat, lon = get_data_as_xr(rundir, year=f'2018{mon}', lev=0, variable=v)
            ...
            plt.tight_layout()
            plt.savefig( f"plots/J100-1000_zonal_mean_{v}_{mon}.png" )
            plt.close()
