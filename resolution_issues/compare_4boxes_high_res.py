...
def main():
    ...
    for v in variables:
        ...
        ds0 = get_data_as_xr('nitrate_photol_control', year='201706', variable=v, version='13.1.2')  
        ds0 = site_data( ds0, ds, lon=site['longitude'], lat=site['latitude'] )
        ds0 = pd.DataFrame({site['save_name']:ds0.values}, index=ds0['time'].values)

        ds1 = get_data_as_xr('nitrate_photol_control', year='201706', variable=v, version='13.1.2')  
