...
def site_data(ds1, ds, lat=16.9, lon=-24.9, lev=0):
    ...
    print( x, y )
    print( ds.lon[x].values, ds.lat[y].values )
    if type(lev)==int:
...
def main():
    ...
    versions = ['13.1.2']
    sname='gridboxes'
    variables=['O3', 'NIT','NITs']#,'NOx','all_nitrate','NIT','NITs', 'NH3','HNO3','all_sulphate']
    years='2018'
    cs=['#1b9e77','#e7298a','#d95f02','#7570b3','#e7298a','#66a61e','#e6ab02']
    for v in variables:
        ...
        add_times=[hr, ds0, dsE, dsNE, dsNW]
        versions=['0.1x0.1','CVAO','Gridbox E','Gridbox NE','Gridbox NW']
