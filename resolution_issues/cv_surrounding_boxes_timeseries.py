...
def main():
    ...
    for v in variables:
        ...
        ds1 = get_data_as_xr('nitrate_photol_control', year='2017', variable=v, version='13.1.2')  
        ...
        versions=['CV gridbox','Gridbox E','Gridbox NE','Gridbox N','Gridbox NW', 'Gridbox_W']
        ...
        plt.legend(loc=0, ncol=2)
        plt.tight_layout()
        plt.savefig( f"plots/cvao_all_nitrate_2011" )
        plt.close()
