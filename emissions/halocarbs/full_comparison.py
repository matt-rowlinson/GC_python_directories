...
p5, = ax.plot(  x,            NMVOC   , c='#984ea3', label='v2021-04-21 NMVOC-em-anthro' )
p4, = ax.plot(  x,            NMVOC_bf, c='#e41a1c',label='v2021-04-21 NMVOC-em-anthro + NMVOC-em-SOLID-BIOFUEL')#+ NMVOC-em-AIR' )
p1, = ax.plot(  x, v21 , ls='-.', c='yellow', label='v2021-04-21 sum of VOC-em-anthro files' )

ax.set_ylabel( 'Anthropogenic NMVOCs (Tg $yr^{-1}$)'  )
ax.set_ylim(bottom=0.)
ax.legend()
plt.savefig( 'plots/full_CEDS_versions_NMVOCs.png' )
plt.close()
