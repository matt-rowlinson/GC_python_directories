...
for i,ii in enumerate(mons):
    ...
    emissions_outfile = Dataset('C3H8-em-Geo_%s.nc' %ii , 'w')
    ...
    new_em  = emissions_outfile.createVariable('Geo_C3H8',float, ('lat','lon'), fill_value=np.nan)
    ...
    emissions_outfile.description  = "File contains C3H8 natural geological emissions produced for use in \
    GEOS-Chem chemical transport model.C3H8 geological emission distribution is based on the CH4 geological \
    emissions grid from Etiope et al. 2019. Global emissions are scaled to 1.7 Tg yr-1, in accordance with \
    Etiope and Ciccioli et al. 2009. File has no monthly or interannual variation, based on 'present-day' estimate annual emissions."
    emissions_outfile.references = "
    Etiope, G. and Ciccioli, P.: Earth’s Degassing: A Missing Ethane and Propane Source, Science, 323, 478–478,
    https://doi.org/10.1126/science.1165904, 2009. ; Etiope, Giuseppe & Ciotoli, Giancarlo & Schwietzke, Stefan & Schoell, Martin. (2019). Gridded maps of geological methane emissions and their isotopic signature. Earth System Science Data. 11. 1-22. 10.5194/essd-11-1-2019. "
