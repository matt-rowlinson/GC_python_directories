...
var, lat, lon, lev, time = GC.get_gc_var(rundir, variable, version, year='2019')
...
plt.ylim((7.5,52.5))
plt.legend()
plt.savefig('/users/mjr583/GC/postprocess/plots/benchmark_timeseries_2019.png' )
plt.close()
...
#plt.ylim((7.5,52.5))
plt.legend()
plt.savefig('/users/mjr583/GC/postprocess/plots/benchmark_comparison_%s_2019.png' %variable )
plt.close()
