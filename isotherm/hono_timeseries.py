...
def main():
    ...
    site = sites[site]
    rundirs  = ['isotherm_OFF','dev_new_base','dev_onlyNIThv','dev_onlyNO-HO2','dev_both']
    rundirs = ['dev_new_base','dev_both','dev_unlimit_HO2nNO', 'dev_lim_HO2nNO']
    versions = ['13.1.2']
    labels=['Base', 'new_Base', 'dev.NIThv','dev.NO-HO2rxn','dev.NIThv+NO-HO2rxn']
    labels=['Base','Both','NoLim_both', 'Lims' ]
    variables=['HNO2'']#, 'HNO3','all_nitrate', 'all_sulphate','HNO2', 'SO4','SO2']
    years='201801'
