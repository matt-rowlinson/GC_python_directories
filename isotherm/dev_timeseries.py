...
def plot(ax, times, obs=False,
    ...
    plt.tight_layout()
    plt.savefig( f"plots/{site['save_name']}_{v}_21-06-22.png" )
    plt.close()
    return
...
def main():
    ...
    site = sites[site]
    versions = ['13.1.2']
    rundirs  = ['dev_new_base','dev_onlyNIThv','dev_both','dev_lim_HO2nNO']
    labels=['Base','Uncapped NIThv','Uncapped NIThv inc. HO2+NO','j50-capped NIThv inc. HO2+NO' ]

    variables=['O3','NOx','HNO2','HNO3','all_nitrate','CO','NH4','all_sulphate','SO4','SO2','C2H6','BENZ','TOLU']
    years='2018'
    ...
    for v in variables[::-1]:
        ...
        try:
            ...
            df=df['2018-01':'2018-12'].resample('D').mean()
