...
def main():
    ...
    sname='DUST_v13-1-2'
    variables=['O3','SALCAL','SALAAL']#NH4','O3','NOx','all_nitrate','NIT','NITs', 'NH4','NH3','HNO3','all_sulphate']
    years='2017'
    cs=['#1b9e77','#e7298a','#d95f02','#7570b3','#e7298a','#66a61e','#e6ab02']
    for v in variables:
        print( v )
        ...
        try:
            ...
            df=df['2017']
            plot( ax, add_times, labels=labels,sname=sname, obs=df)
        except:
            plot(ax, add_times, labels=labels, sname=sname)
