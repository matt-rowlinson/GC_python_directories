...
def main():
    ...
    variables=['O3','SALAAL','SALCAL','HNO3','Iy','SALAAL','SALCAL','O3','CO','NITA','SO4A','NIT', 'NITs','SO4','SO2','all_nitrate','all_sulphate','NH3','NH4']
    units = ['pptv','pptv','pptv','pptv','pptv','ppbv','ppbv','pptv','pptv','pptv','pptv','pptv','pptv','pptv','pptv','pptv','ppbv'][::-1]
    for nn, v in enumerate(variables):
        ...
        plot( f, axes, add_plottable, lat, lon, c=cmap, 
                ...
                labels=['v13.1.2_wDust - v13.1.2','v13.1.2_wDust / v13.1.2'],
                sname=f'v13_DUST_{v}')
