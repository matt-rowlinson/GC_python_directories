...
def main():
    ...
    for s in species:
        ...
        cart_plot( s, rundirs, base_, j100_, plot_type='pc' , sname=f'all5_maps_2010-2015_{s}')
        cart_plot( s, rundirs, base_, j100_, plot_type='abs', sname=f'all5_maps_2010-2015_{s}')
