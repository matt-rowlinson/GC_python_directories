...
def surface_data(species, rundirs, versions=['13.1.2']):
    ...
    for n, rundir in enumerate(rundirs):
        ...
        ds0 = ds0.where( 11. < ds0.lat , drop=True )
        ds0 = ds0.where( ds0.lat < 49. , drop=True )
        ds0 = ds0.where( 80. < ds0.lon , drop=True )
        ds0 = ds0.where( ds0.lon < 148. , drop=True )
        add_.append( ds0 )
...
def main():
    ...
    for s in species:
        ...
        cart_plot( s, rundirs, base_, j100_, plot_type='pc' , sname=f'Asiaall5_maps_2010-2015_{s}')
        cart_plot( s, rundirs, base_, j100_, plot_type='abs', sname=f'Asiaall5_maps_2010-2015_{s}')
